...
// 관리자
const admins = [
  {id: 1, firstName: 'test', lastName: 'admin', email: 'gisholic+admin@gmail.com', password: 'admin', emailVerified: 1},
];
// 바이어
const buyers = [
  {id: 1, firstName: 'test', lastName: 'buyer', email: 'gisholic+buyer@gmail.com', password: 'buyer', emailVerified: 1},
];
// 셀러
const sellers = [
  {id: 1, firstName: 'test', lastName: 'seller', email: 'gisholic+seller@gmail.com', password: 'seller', emailVerified: 1},
];
